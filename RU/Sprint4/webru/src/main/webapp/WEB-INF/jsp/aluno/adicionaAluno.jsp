...
<body>
    ...
    <div class="row">
    	...
    	<div class="col s5">
    		...
    		<form action="<c:url value="/aluno/cadastrarAluno"/>" method="post">
				Nome:<input type="text" name="aluno.nome">
				Matrícula:<input type="text" name="aluno.matricula"><br> 
				<button class="btn waves-effect waves-light" type="submit" name="action">Salvar
    				<i class="material-icons right">send</i>
  				</button>
  				<a href="${linkTo[AlunoController].listar}"class="waves-effect waves-light btn"><i class="material-icons left">cloud</i>Bolsistas cadastrados</a>
			</form>
    	</div>
    </div>
