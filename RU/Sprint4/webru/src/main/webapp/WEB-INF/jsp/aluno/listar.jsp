    ...
    <div class="row">
        ...
        <c:forEach items="${alunos}" var="alunos">
        	<tr>
				...
				<td><a href="${linkTo[AlunoController].editarAluno}?matricula=${alunos.matricula}">Modificar</a></td>
				<td><a href="${linkTo[AlunoController].deletar}?matricula=${alunos.matricula}">Excluir</a></td>
          </tr>
        </c:forEach>
        </tbody>
      </table>
