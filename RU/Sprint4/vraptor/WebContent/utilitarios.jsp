...
<ul id="slide-out" class="side-nav fixed #00897b teal darken-1">
   		...
   		<li><a href="utilitarios.jsp"><i class="small material-icons">apps</i>Utilitários</a></li>
    </ul>
    <div class="row">
    ...
    <div class="row">
    	...
    	<div class="col s2">
    		<a href="${linkTo[ParametroController].listParametros}"><img src="img/parametros.png"></a>
    	</div>
    </div>	
</body>
</html>